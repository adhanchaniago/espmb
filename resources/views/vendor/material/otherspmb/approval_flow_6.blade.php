...
@section('content')
    <div class="card">
        <div class="card-header"><h2>SURAT PERMINTAAN MEMBELI BARANG PO BELAKANG<small>Penyelesaian</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('otherspmb/approve/' . $spmb->flow_no . '/' . $spmb->spmb_id) }}">
        		...
        		@include('vendor.material.otherspmb.approval_flow_6-table')
    ...
    @include('vendor.material.otherspmb.update-payment-vendor-modal')
    @include('vendor.material.otherspmb.give-rating-modal')
@endsection
