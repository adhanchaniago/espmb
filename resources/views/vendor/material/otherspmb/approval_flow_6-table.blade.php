			...
			<tr>
				...
				<td>
					<center>
						...
						<a title="Update Pembayaran" href="javascript:void(0)" class="btn btn-icon waves-effect waves-circle update-payment-spmb-item" data-detail-id="{{ $detail->spmb_detail_id }}" type="button"><span class="zmdi zmdi-money"></span></a>&nbsp;
						<a title="Beri Penilaian" href="javascript:void(0)" class="btn btn-icon waves-effect waves-circle give-rating-spmb-item" data-detail-id="{{ $detail->spmb_detail_id }}" type="button"><span class="zmdi zmdi-star"></span></a>&nbsp;
					</center>
				</td>
			</tr>
		@endforeach
...
<script src="{{ url('js/otherspmb/update-payment.js') }}"></script>
<script src="{{ url('js/otherspmb/give-rating.js') }}"></script>
@endsection