...
@section('content')
    <div class="card">
        <div class="card-header"><h2>SURAT PERMINTAAN MEMBELI BARANG PO BELAKANG<small>Edit SPMB PO Belakang</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('otherspmb/' . $spmb->spmb_id) }}">
        		{{ csrf_field() }}
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="text" name="spmb_no_pr_sap" id="spmb_no_pr_sap" class="form-control input-sm" placeholder="No PR SAP" maxlength="10" value="{{ $spmb->spmb_no_pr_sap }}">
	            		</div>
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="text" name="spmb_buyer_no" id="spmb_buyer_no" class="form-control input-sm" placeholder="No Pemesan" maxlength="20" value="{{ $spmb->spmb_buyer_no }}" required="true" readonly="true">
	            		</div>
