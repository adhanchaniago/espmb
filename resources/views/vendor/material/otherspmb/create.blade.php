...
@section('content')
    <div class="card">
        <div class="card-header"><h2>SURAT PERMINTAAN MEMBELI BARANG PO BELAKANG<small>Create New SPMB PO Belakang</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('otherspmb') }}">
        		{{ csrf_field() }}
	                    ...
	                    <div class="fg-line">
	                        <select name="spmb_type_id" id="spmb_type_id" class="selectpicker" data-live-search="true" required="true">
                                ...
                                @foreach ($spmb_types as $row)
                                	{!! $selected = '' !!}
                                	@if($row->spmb_type_id==old('spmb_type_id'))
                                		{!! $selected = 'selected' !!}
                                	@endif
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="text" name="spmb_group" id="spmb_group" class="form-control input-sm" placeholder="Kelompok" maxlength="50" value="{{ old('spmb_group') }}">
	            		</div>
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="text" name="spmb_cost_center" id="spmb_cost_center" class="form-control input-sm" placeholder="Cost Center" maxlength="20" value="{{ old('spmb_cost_center') }}" required="true">
	            		</div>
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="text" name="spmb_io_no" id="spmb_io_no" class="form-control input-sm" placeholder="No I/O DIPK" maxlength="20" value="{{ old('spmb_io_no') }}" required="true">
	            		</div>
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="text" name="spmb_applicant_name" id="spmb_applicant_name" class="form-control input-sm" placeholder="Nama Pemesan" maxlength="50" value="{{ old('spmb_applicant_name') }}" required="true">
	            		</div>
	            ...
	            <div class="form-group">
	            	...
	            	<div class="col-sm-10">
	            		<div class="fg-line">
	            			<input type="email" name="spmb_applicant_email" id="spmb_applicant_email" class="form-control input-sm" placeholder="E-mail Pemesan" maxlength="100" value="{{ old('spmb_applicant_email') }}" required="true">
	            		</div>
    ...
    @include('vendor.material.otherspmb.modal')
@endsection
...
@section('customjs')
<script src="{{ url('js/otherspmb/create.js') }}"></script>
@endsection