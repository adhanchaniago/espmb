...
@section('content')
    <div class="card">
        <div class="card-header"><h2>Division/Unit Management<small>Create New Division/Unit</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('master/division') }}">
        		...
        		<div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="division_code" id="division_code" placeholder="Cost Center" required="true" maxlength="10" value="{{ old('division_code') }}">
	                    </div>
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-10">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="division_name" id="division_name" placeholder="Unit Name" required="true" maxlength="100" value="{{ old('division_name') }}">
	                    </div>
