        ...
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form">
	            ...
	            <div class="form-group">
	                ...
	                <div class="col-sm-7">
	                    <div class="fg-line">
	                        <input type="text" class="form-control input-sm" name="division_code" id="division_code" placeholder="Division Code" required="true" maxlength="10" value="{{ $division->division_code }}" disabled="true">
	                    </div>
	                </div>
	            </div>
	            <div class="form-group">
