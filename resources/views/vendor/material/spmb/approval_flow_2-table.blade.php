			...
			<tr>
				...
				<td>
					<center>
						...
						<a title="Cari Vendor" href="javascript:void(0)" class="btn btn-icon command-search waves-effect waves-circle search-vendor-spmb-item" data-detail-id="{{ $detail->spmb_detail_id }}" data-item-id="{{ $detail->item_category_id }}" type="button"><span class="zmdi zmdi-search"></span></a>
					</center>
				</td>
			</tr>
		@endforeach
...
<script src="{{ url('js/spmb/search-vendor.js') }}"></script>
@endsection