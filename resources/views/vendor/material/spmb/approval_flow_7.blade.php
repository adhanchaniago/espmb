...
@section('content')
    <div class="card">
        <div class="card-header"><h2>SURAT PERMINTAAN MEMBELI BARANG<small>Penerimaan Barang - MIGO</small></h2></div>
        <div class="card-body card-padding">
        	<form class="form-horizontal" role="form" method="POST" action="{{ url('spmb/approve/' . $spmb->flow_no . '/' . $spmb->spmb_id) }}">
        		...
        		@include('vendor.material.spmb.approval_flow_7-table')
    ...
    @include('vendor.material.spmb.accept-modal')
@endsection
