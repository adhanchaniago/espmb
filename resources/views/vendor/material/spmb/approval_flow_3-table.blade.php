			...
			<tr>
				...
				<td>
					<center>
						...
						<a title="Negosiasi" href="javascript:void(0)" class="btn btn-icon command-search waves-effect waves-circle negotiation-vendor-spmb-item" data-detail-id="{{ $detail->spmb_detail_id }}" data-item-id="{{ $detail->item_category_id }}" type="button"><span class="zmdi zmdi-assignment-check"></span></a>
					</center>
				</td>
			</tr>
		@endforeach
...
<script src="{{ url('js/spmb/negotiation.js') }}"></script>
@endsection